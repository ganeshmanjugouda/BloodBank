    ...
    <div class="container mt-4">
        <div class="row justify-content-center">
            <div class="col-md-5">
                <div class="card">
                    <div class="card-body">
                        <h1 class="text-center form-control badge-info font-weight-bold">New Donar</h1>
                        <hr>
                        <form action="actions.php" method="post" id="formAddDonar" enctype="multipart/form-data">
                            <input type="hidden" name="command" value="addDonar"/>
                            ...
                            <div class="form-group">
                                <input class="form-control" id="quantity" name="quantity"
                                       placeholder="Quantity (470 ml Max)" autocomplete="off" required/>
                            </div>

                            <div class="form-group">
                                <button class="btn btn-secondary btn-block" type="submit">Save Donar</button>
                            </div>
                            <?php
